...
### Authentication
- **Email Verification**: Password-based authentication with email verification via Supabase Auth
...
3. Enable **Confirm email** (email verification)
...
1. **Login**: Enter your email and password, verify your email if first time
...
Built with React, TypeScript, and Supabase# CRM System - Role-Based Access Control
